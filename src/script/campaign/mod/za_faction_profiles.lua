--[[===========================================================================
  ...
  lords= 전설군주 subtype_key → {name, note}. 키는 db.pack frontend_faction_leaders 실측.
         (대표 군주 1인 우선 수록; 나머지는 인게임 로그로 확인해 점진 확장.)
...
CA_FACTION_PROFILES = {
  ...
  ["wh_main_sc_emp_empire"] = { race="제국", identity="선제후를 외교·연합으로 통합, 초반 방어→후반 강국",
    ...
    lords={ ["wh_main_emp_karl_franz"]={name="카를 프란츠", note="중앙 라이클란트의 만능·결투가. 초반 카즈락·분리주의자 등 근처 위협을 제거하고 선제후를 규합하세요"},
  ...
  ["wh3_main_sc_ksl_kislev"] = { race="키슬레프", identity="카오스 맞선 북방 방벽. 코사르+곰+얼음마법",
    ...
    lords={ ["wh3_main_ksl_katarin"]={name="차리나 카타린", note="얼음마법 여왕, 방어적 표준 시작. 카오스를 사냥해 헌신을 모으세요"} } },
  ["wh3_main_sc_cth_cathay"] = { race="카타이", identity="원거리 총진+용군주+포병 방어형. 조화·교역 제국",
    ...
    lords={ ["wh3_main_cth_miao_ying"]={name="미아오 잉", note="대보루 최전선 방어 특화. 관문 수비를 최우선으로, 조화를 유지하세요"} } },
  ...
  ["wh_main_sc_dwf_dwarfs"] = { race="드워프", identity="느리지만 무너지지 않는 방어형. 원한·룬·사격라인",
    ...
    lords={ ["wh_main_dwf_thorgrim_grudgebearer"]={name="토그림 그루지베어러", note="원한서 리더, 원한 해결 보너스 강화. 정석대로 값싼 원한부터 정산하세요"} } },
  ["wh2_main_sc_hef_high_elves"] = { race="하이 엘프", identity="정예+정치력. 영향력·후원으로 전쟁 조율·규합(7.0)",
    ...
    lords={ ["wh2_main_hef_tyrion"]={name="티리온", note="근접·기병 최강에 영향력 병행. 울투안 방어의 정석, 후원을 선점하세요"},
            ["wh2_main_hef_teclis"]={name="테클리스", note="전 로어 마법 마스터지만 사우스랜드 고립 스타트 — 초반 방어에 유의하세요"} } },
  ["wh_dlc05_sc_wef_wood_elves"] = { race="우드 엘프", identity="정예 궁병·기동 게릴라. 앰버·숲치유·월드루트",
    ...
    lords={ ["wh_dlc05_wef_orion"]={name="오리온", note="야생 사냥 계절 공세, 근접 야수사냥꾼. 가장 공격적 — 앰버를 모으며 치고 빠지세요"} } },
  ["wh2_main_sc_lzd_lizardmen"] = { race="리자드맨", identity="공룡·괴수+슬란 마법 만능강군. 지오맨틱 웹·리테",
    ...
    lords={ ["wh2_main_lzd_lord_mazdamundi"]={name="마즈다문디", note="슬란 마법+지오맨틱 웹 마스터. 방어-확장 정석, 웹을 계획적으로 연결하세요"} } },
  ...
  ["wh_main_sc_grn_greenskins"] = { race="그린스킨", identity="싸워야 강해지는 공격형. WAAAGH!·스크랩 스노우볼",
    ...
    lords={ ["wh_main_grn_grimgor_ironhide"]={name="그림고르 아이언하이드", note="순수 근접 최강 브롤러, 여유로운 시작. 쉼 없이 싸워 WAAAGH!를 굴리세요"} } },
  ["wh_dlc03_sc_bst_beastmen"] = { race="비스트맨", identity="정착지 부수는 유목 히트앤런. 허드스톤·드레드",
    ...
    lords={ ["wh2_dlc17_bst_taurox"]={name="타우록스", note="Rampage 연승 모멘텀, 괴수 둠스택. 초심자 친화 순수 전투형 — 계속 몰아치세요"} } },
  ...
  ["wh_dlc08_sc_nor_norsca"] = { race="노스카", identity="약탈 침략자. 4대신 제단+전리품 경제(7.0)",
    ...
    lords={ ["wh_dlc08_nor_wulfrik"]={name="울프릭", note="강적을 찾아다니는 도전형, 몬스터 헌트 자유. 해안을 약탈하며 4신 제단을 세우세요"} } },
  ["wh3_main_sc_ogr_ogre_kingdoms"] = { race="오거 킹덤", identity="고기로 굴러가는 용병형. 캠프·계약 반유목",
    ...
    lords={ ["wh3_main_ogr_greasus_goldtooth"]={name="그리서스 골드투스", note="오버타이런트, 오거 외교 유리. 동맹·통합·조공을 활용하며 캠프로 확장하세요"} } },
  ...
  ["wh3_main_sc_kho_khorne"] = { race="코른", identity="순수 학살. 외교·경제 포기, 멈추면 약해짐",
    ...
    lords={ ["wh3_main_kho_skarbrand"]={name="스카브란드", note="캠페인 최강급 전투군주, 킬마다 강화. 입문 추천 — 쉼 없이 학살하세요"} } },
  ["wh3_main_sc_nur_nurgle"] = { race="너글", identity="내구·역병·소모전. 부패로 갉아먹는 스노우볼",
    ...
    lords={ ["wh3_main_nur_kugath"]={name="쿠가스 플레이그파더", note="고립된 안전한 시작, 표준 역병 플레이. 입문 추천 — 감염을 흑자화하세요"} } },
  ["wh3_main_sc_tze_tzeentch"] = { race="젠취", identity="마법·기만. 그리모어 술책·변화의 격변·순간이동",
    ...
    lords={ ["wh3_main_tze_kairos"]={name="카이로스 페이트위버", note="최강 스펠캐스터, 전승 혼합 유연성. 안정적 시작 — 그리모어로 기술을 밀어붙이세요"} } },
  ["wh3_main_sc_sla_slaanesh"] = { race="슬라네쉬", identity="속도·유혹. 최고 기동 치고빠지기+속국화",
    ...
    lords={ ["wh3_main_sla_nkari"]={name="엔카리", note="유일 슬라네쉬 군주, 울투안 시작이 까다로움. 기동으로 치고 빠지며 유혹으로 속국화하세요"} } },
  ["wh3_main_sc_dae_daemons"] = { race="카오스 데몬", identity="4대신 자유 조합 만능. 데몬프린스 커스텀·영광",
    ...
    lords={ ["wh3_main_dae_daemon_prince"]={name="데몬 프린스", note="완전 커스터마이즈, 초반 생존이 관건. 역할을 정해 방어를 보강하고 1~2신에 집중하세요"} } },
  ["wh3_dlc23_sc_chd_chaos_dwarfs"] = { race="카오스 드워프", identity="산업·경제 지배. 노동력·헬포지, 느린 시작 최상위 후반",
    ...
    lords={ ["wh3_dlc23_chd_astragoth"]={name="아스트라고스", note="주변을 겁박해 노동력 확보 좋은 표준 시작. 노동력을 극대화하고 자르 탑을 선점하세요"} } },
  ...
  ["wh_main_sc_vmp_vampire_counts"] = { race="뱀파이어 카운트", identity="마법+붕괴없는 언데드 소모전. 사자 소환 공짜 보충",
    ...
    lords={ ["wh_dlc04_vmp_vlad_con_carstein"]={name="블라드 폰 카스타인", note="VC 최강·추천, 결투가+캐스터·부활. 제국·키슬레프로 손쉽게 확장하세요"} } },
  ["wh2_dlc09_sc_tmb_tomb_kings"] = { race="툼 킹", identity="무료 군대+부대 상한. 인프라·상한 키워 후반 전환",
    ...
    lords={ ["wh2_dlc09_tmb_settra"]={name="세트라", note="최고급 로스터·자금이나 외교 페널티 극심(동맹 불가). 네헤카라 통일을 지향하세요"} } },
  ["wh2_dlc11_sc_cst_vampire_coast"] = { race="뱀파이어 코스트", identity="해적 은신처 경제+화약포병 '건볼' 화력",
    ...
    lords={ ["wh2_dlc11_cst_harkon"]={name="루터 하콘", note="초보 친화 균형형, 리자드맨과 대치. 항구를 Cove로 도배해 경제를 구축하세요"} } },
  ["wh2_main_sc_def_dark_elves"] = { race="다크 엘프", identity="노예로 경제·건설, 살육의 기세로 폭발. 초공격형",
    ...
    lords={ ["wh2_main_def_malekith"]={name="말레키스", note="하이브리드·통일 지향의 균형·강력한 시작. 다크 엘프를 규합하며 노예를 사냥하세요"} } },
  ["wh2_main_sc_skv_skaven"] = { race="스케이븐", identity="소모물량 탱킹+무기팀·포병. 언더엠파이어·식량",
    ...
    lords={ ["wh2_dlc12_skv_ikit_claw"]={name="이킷 클로", note="공방·둠로켓·워프 무기팀 특화, 최상급 기술 둠스택. 식량을 관리하며 언더엠파이어를 확장하세요"} } },
}
